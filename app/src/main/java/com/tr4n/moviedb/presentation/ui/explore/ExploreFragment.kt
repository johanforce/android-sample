...
class ExploreFragment :
    ...
    override fun setupViews() {
        viewBD.recyclerTopRatedMovies.adapter = searchMoviesAdapter.apply {
            onItemClick = { item, _ ->
    ...
    override fun initData() {
        ...
        viewBD.recyclerTopRatedMovies.isVisible = true
    ...
    private fun handleClickSearch() {
        ...
        if (text.length < 3)
            Toast.makeText(activity, getString(R.string.input_3_characters), Toast.LENGTH_SHORT)
                .show()
    ...
    override fun observeData() {
        viewModel.listMovies.observe(viewLifecycleOwner) { movies ->
            ...
            viewBD.recyclerTopRatedMovies.isVisible = movies.isNotEmpty()
