...
open class CalendarView : RecyclerView {
    ...
    private var isScrollHorizontalEnabled = true
    ...
    private fun init(attributeSet: AttributeSet, defStyleAttr: Int, defStyleRes: Int) {
        ...
        context.withStyledAttributes(attributeSet, R.styleable.CalendarView, defStyleAttr, defStyleRes) {
            ...
            isScrollHorizontalEnabled = getBoolean(R.styleable.CalendarView_cv_isCanScrollHorizontal, true)
...
//        val calendarManager = CalendarLayoutManager(this, orientation)
//        calendarManager.isScrollHorizontalEnabled = isScrollHorizontalEnabled
        layoutManager = CalendarLayoutManager(this, orientation).apply { isCanScrollHorizontal = isScrollHorizontalEnabled }
